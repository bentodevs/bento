 ...
 */
exports.getAllCountryData = (sort) => {
    return new Promise((resolve, reject) => {
 ...
 */
 exports.getDataByCountry = (country) => {
    return new Promise((resolve, reject) => {
 ...
 */
exports.getDataByContinent = (continent) => {
    return new Promise((resolve, reject) => {
 ...
 */
exports.getVaccineData = (days, full, type, data) => {
    return new Promise((resolve, reject) => {
        // If an invalid type is specified return an error
        if (type && !["countries", "states"].includes(type))
            return reject(new Error("Invalid Args!"));
