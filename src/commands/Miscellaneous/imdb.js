...
export default {
    ...
    run: async (bot, message, args) => {
        ...
        if (json.Response !== 'True') return message.errorReply('A film/show could not be found with that name! Make sure your search is accurate and try again!');
    ...
    run_interaction: async (bot, interaction) => {
        ...
        // If the response isn't "True" return an error
        if (json.Response !== 'True') return interaction.error('A film/show could not be found with that name! Make sure your search is accurate and try again!');
