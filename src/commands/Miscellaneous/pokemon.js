...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        const data = await bot.pokedex.getPokemonByName(args.join(" ")).then(data => { return data; }).catch(() => {
            // Return an error
        ...
        const embed = new MessageEmbed()
            ...
            .setDescription(`⚖️ **Weight:** ${data.weight}
            📏 **Height:** ${data.height}
    ...
    run_interaction: async (bot, interaction) => {
        ...
        // Get the pokemon data
        const data = await bot.pokedex.getPokemonByName(interaction.options.get("pokemon").value).then(data => { return data; }).catch(() => {
            // Return an error
