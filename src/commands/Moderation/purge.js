export default {
    ...
    run: async (bot, message, args) => {
        ...
        let deleteCount = parseInt(args[0], 10) + 2;
        let actualCount = 0;

        // If no amount of messages were specified return an error
        if (!deleteCount) return message.errorReply("You didn't specify a number of messages to purge!");
        ...
        async function bulkDelete() {
            ...
            if (deleteCount > 100) return bulkDelete();
