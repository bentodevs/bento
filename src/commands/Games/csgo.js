...
const { fetchSteamUser } = require("../../modules/functions/misc");
                    ...
                    .then(async csUser => {
                        ...
                        const embed = new MessageEmbed()
                            ...
                            **Total time played:** ${timePlayed}
                            ${user.playerstats.stats.find(a => a.name === "total_planted_bombs").value} **bombs planted** | ${user.playerstats.stats.find(a => a.name === "total_defused_bombs").value} **bombs defused**
