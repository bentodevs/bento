...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        // Catch any errors
        if (champ === 'NO_CHAMP_FOUND') return message.errorReply("It looks like you didn't provide a valid Champion!");
    ...
    run_interaction: async (bot, interaction) => {
        ...
        // Catch any errors
        if (champ === 'NO_CHAMP_FOUND') return interaction.error("It looks like you didn't provide a valid champion!");
