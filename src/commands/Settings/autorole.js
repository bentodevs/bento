    ...
    run: async (bot, message, args) => {
        if (!args[0]) {
            ...
            if (message.settings.roles.auto.length) {
                ...
                if (!roles.length) return message.errorReply("There aren't any auto roles setup!");
            ...
            if (args[0].toLowerCase().includes('disable')) {
                ...
                if (!role) message.errorReply("You didn't specify a valid role!");
    ...
    run_interaction: async (bot, interaction) => {
        ...
        if (sub === 'view') {
            ...
            if (interaction.settings.roles.auto.length) {
                ...
                // If no roles were found return an error
                if (!roles.length) return interaction.error("There aren't any auto roles setup!");
            ...
            // If the role doesn't exist return an error
            if (!r) interaction.error("You didn't specify a valid role!");
            ...
            if (interaction.settings.roles.auto.includes(r.id)) {
                ...
                // If the role is higher than or equal to the bots highest role return an error
                if (interaction.guild.me.roles.highest.position <= r.position) return interaction.error('That role is higher than or equal to my highest role!');
                // If the role is higher than or equal to the users highest role return an error
                if (interaction.member.roles.highest.position <= r.position) return interaction.error('That role is higher than or equal to your highest role!');
