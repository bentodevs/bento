...
import {
    ...
    BaseGuildTextChannel, BaseGuildVoiceChannel, CategoryChannel, ChannelType, ChatInputCommandInteraction, EmbedBuilder, GuildBasedChannel, GuildMember, PermissionFlagsBits,
} from 'discord.js';
